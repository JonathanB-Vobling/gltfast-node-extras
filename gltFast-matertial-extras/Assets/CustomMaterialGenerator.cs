...
{  
    ...
    public class CustomMaterialGenerator : MaterialGenerator {
        ...
        public override Material GenerateMaterial(
            ...
            if(gltfMaterial.alphaModeEnum == Schema.Material.AlphaMode.MASK) {
                material.SetFloat(cutoffPropId, gltfMaterial.alphaCutoff);
                shaderMode = StandardShaderMode.Cutout;
            } else if(gltfMaterial.alphaModeEnum == Schema.Material.AlphaMode.BLEND) {
